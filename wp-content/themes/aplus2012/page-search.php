...
<form id="searchbox_014701419262400121822:j6q7g-b7kra" action="<?php bloginfo('url');?>/search" style="margin:0px;padding:0px;">
...
<!-- Google Search Result Snippet Begins -->
  <div id="results_014701419262400121822:j6q7g-b7kra" style="padding:0px;width:690px;float:left;height:1020px;overflow:hidden;">
