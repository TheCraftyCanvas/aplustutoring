			...
			echo '<div class="accordion-area clearfix">';
				...
				echo '<div class="fields-area">';
					...
					echo '<div class="optin-input-meta">';
						...
						echo '</p>';
						echo '<p>';
							echo '<label for="om-slide-' . $theme_type . '-name-size">Optin Name Field Font Size</label>';
							echo '<input id="om-slide-' . $theme_type . '-name-size" data-target="om-slide-' . $theme_type . '-optin-name" name="optin_name_size" class="optin-size" type="text" value="' . $tab->get_field( 'name', 'size' ) . '" placeholder="e.g. 36" />';
						echo '</p>';
					echo '</div>';
					echo '<p>';
					...
					echo '<div class="optin-input-meta">';
						...
						echo '</p>';
						echo '<p>';
							echo '<label for="om-slide-' . $theme_type . '-email-size">Optin Email Field Font Size</label>';
							echo '<input id="om-slide-' . $theme_type . '-email-size" data-target="om-slide-' . $theme_type . '-optin-email" name="optin_email_size" class="optin-size" type="text" value="' . $tab->get_field( 'email', 'size' ) . '" placeholder="e.g. 36" />';
						echo '</p>';
					echo '</div>';
					echo '<p>';
					...
					echo '<div class="optin-input-meta last">';
						...
						echo '</p>';
						echo '<p>';
							echo '<label for="om-slide-' . $theme_type . '-submit-size">Optin Submit Field Font Size</label>';
							echo '<input id="om-slide-' . $theme_type . '-submit-size" data-target="om-slide-' . $theme_type . '-optin-submit" name="optin_submit_size" class="optin-size" type="text" value="' . $tab->get_field( 'submit', 'size' ) . '" placeholder="e.g. 36" />';
						echo '</p>';
					echo '</div>';
