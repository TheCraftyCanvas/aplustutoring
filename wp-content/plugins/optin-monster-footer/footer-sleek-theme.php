<?php
/**
 * Builds out the footer sleek theme.
 *
 ...
 * @since        1.0.0
 */
class optin_monster_build_footer_sleek_theme {
	...
	/**
	 * Builds out a footer optin using the "sleek Theme".
	 *
	 * @since 1.0.0
	 */
	public function build() {
		...
		$theme .= '<div id="om-footer-' . $this->theme . '-optin" class="om-footer-' . $this->theme . ' om-clearfix ' . $class . '" style="' . $bg . '">';
